...
password = 'sparta'
cxn_str = f'mongodb+srv://test:{password}@cluster0.l0kdl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
client = MongoClient(cxn_str)

db = client.dbsparta_plus_chap8
...
def save_ex():
    ...
    return jsonify({
        'result': 'success',
        'msg' : f'your examples, {example},for the word, {word}, was saved!',
        })
